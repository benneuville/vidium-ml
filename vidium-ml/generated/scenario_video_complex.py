...
scene.add_layer(element_0, name="element_0",  transform=element_0_transform , offset=4, start_time=0.0, end_time=18.088345)
...
element_4_transform = mv.Transform(position=(1920/2, 1080/2), scale=(2, 2), rotation=0, opacity=0.3)
