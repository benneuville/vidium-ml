...
scene.add_layer(element_0, name="element_0",  transform=element_0_transform , offset=0, start_time=0.0, end_time=element_0.duration)
...
scene.add_layer(element_1, name="element_1", transform=element_1_transform , offset=1, start_time=0.0, end_time=2)
...
scene.add_layer(element_2, name="element_2", transform=element_2_transform , offset=3, start_time=0.0, end_time=4)
...
scene.add_layer(element_3, name="element_3", transform=element_3_transform , offset=1, start_time=0.0, end_time=0)
...
scene.add_layer(element_4, name="element_4", transform=element_4_transform , offset=0, start_time=0.0, end_time=2)
