...
scene.add_layer(element_0, transform=element_0_transform , offset=0, start_time=0.0, end_time=element_0.duration)
...
scene.add_layer(element_1, transform=element_1_transform , offset=1, start_time=0.0, end_time=2)
...
scene.add_layer(element_2, transform=element_2_transform , offset=3, start_time=0.0, end_time=4)
...
scene.add_layer(element_3, transform=element_3_transform , offset=1, start_time=0.0, end_time=1)
...
scene.add_layer(element_4, transform=element_4_transform , offset=0, start_time=0.0, end_time=2)

element_5 = mv.layer.Text("COUCOU", font_size=50, color="#ff0000")
element_5_transform = mv.Transform(position=(1920/2, 1080/2), scale=(2, 2), rotation=0, opacity=0.3)
scene.add_layer(element_5, transform=element_5_transform , offset=2, start_time=0.0, end_time=4)
