...
scene.add_layer(element_4, name="element_4", transform=element_4_transform , offset=4, start_time=0.0, end_time=0)
...
scene.add_layer(element_5, name="element_5", transform=element_5_transform , offset=4, start_time=0.0, end_time=0)
